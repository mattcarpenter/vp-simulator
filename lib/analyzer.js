(function () {
	...
	function evaluate(hand) {
		...
		if (twoCardHands.twoSuitedHighCards) {
		...
		if (threeCardHands.threeToStraightFlush) {
		...
		if (twoCardHands.twoUnsuitedHighCards) {
